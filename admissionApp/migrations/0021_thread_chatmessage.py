# Generated by Django 4.0.1 on 2022-03-17 02:57
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('admissionApp', '0020_remove_examschedule_prepared_by'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('timestamp', models.DateTimeField(auto_now_add=True)),
                ('thread', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='chatmessage_thread', to='admissionApp.thread')),
